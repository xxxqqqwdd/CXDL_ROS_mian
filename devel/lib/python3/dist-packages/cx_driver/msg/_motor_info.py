...
"""autogenerated by genpy from cx_driver/motor_info.msg. Do not edit."""
import codecs
import sys
...
class motor_info(genpy.Message):
  _md5sum = "e581c8420d38dcd98d0263cda11f3fb6"
  _type = "cx_driver/motor_info"
...
uint8 dlc
uint8[8] data"""
  __slots__ = ['id','is_rtr','is_extended','is_error','dlc','data']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,is_rtr,is_extended,is_error,dlc,data
